#### an easy app to toast user's location on screen. need to type in longtitude and latitude to degeolocate the address. need to provide data as in second picture.
